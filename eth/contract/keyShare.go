...
//
// Solidity: function loginFunc(address _addr, string _account, string _password) view returns(bool, uint8)
func (_KeyShare *KeyShareCaller) LoginFunc(opts *bind.CallOpts, _addr common.Address, _account string, _password string) (bool, uint8, error) {
	var out []interface{}
...
//
// Solidity: function loginFunc(address _addr, string _account, string _password) view returns(bool, uint8)
func (_KeyShare *KeyShareSession) LoginFunc(_addr common.Address, _account string, _password string) (bool, uint8, error) {
...
//
// Solidity: function loginFunc(address _addr, string _account, string _password) view returns(bool, uint8)
func (_KeyShare *KeyShareCallerSession) LoginFunc(_addr common.Address, _account string, _password string) (bool, uint8, error) {
	return _KeyShare.Contract.LoginFunc(&_KeyShare.CallOpts, _addr, _account, _password)
}
